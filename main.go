...
func main() {
	...
	mux.HandleFunc("/admin/api/accounts/bulk-revive", AuthMiddleware(ah.BulkRevive))
	mux.HandleFunc("/admin/api/accounts/bulk-delete", AuthMiddleware(ah.BulkDelete))
	mux.HandleFunc("/admin/api/accounts/warmup", AuthMiddleware(ah.WarmupAccounts))
	mux.HandleFunc("/admin/api/accounts/warmup/status", AuthMiddleware(ah.WarmupStatus))
	...
	mux.HandleFunc("/admin/api/proxies/random", ah.ProxyRandom)
